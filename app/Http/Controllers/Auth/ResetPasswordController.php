...
class PasswordResetController extends Controller
{
    ...
    public function create(Request $request)
    {
		...
		if (!$user) return response()->json(['message' => 'We cannot find a user with that e-mail address.'], 404);
    ...
    public function reset(Request $request)
    {
		...
		if (!$user) return response()->json(['message' => 'We cannnot find a user with that e-mail address.'], 404);
